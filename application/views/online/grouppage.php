...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo base_url();?>assets/images/mbr-182x121.jpg" type="image/x-icon">
  ...
  <link rel="stylesheet" href="<?php echo base_url();?>assets/mobirise/css/mbr-additional2.css" type="text/css">
...
<a href="https://mobirise.me/n">landing page html templates</a>
</section>
<!--  slide show start -->
  <?php $this->load->view('online/component/background.php');?>
<!--  slide show end -->
<!--  Center group list image start -->
  <?php $this->load->view('online/component/centergroup.php');?>
<!-- List image end -->
<!--  footer start -->
  <?php $this->load->view('online/component/footer.php')?>
<!--  footer end -->
...
<!--  script js -->
  ...
  <script src="<?php echo base_url();?>assets/mbr-clients-slider/mbr-clients-slider.js"></script>
